...
LINTERFLAGS=--enable-all --disable gochecknoinits --disable gochecknoglobals --disable goimports --disable wsl --disable gci --disable gofumpt --out-format=tab --tests=false
BUILDFLAGS=$(LDFLAGS)
